...
% Quant gain = 
on_tstamp = {'2017_07_28_05:03:43'};
off_tstamp = {'2017_07_28_05:04:37'};
...
if ~exist(filename, 'file') || overwrite == 1
    [R, az_off, el_off] = aggregate_banks_one(save_dir, projID, tmp_stmp);
...
if ~exist(filename, 'file') || overwrite == 1
    [R, az, el] = aggregate_banks_one(save_dir, projID, tmp_stmp);
...
[w, Pon, Poff, snr] = Single_beam(Ron, Roff, Nbins, good_idx, bad_freqs);

weights = zeros(64, 500, 14);
for i = 1:14
    weights(:,:,i) = w;
end
